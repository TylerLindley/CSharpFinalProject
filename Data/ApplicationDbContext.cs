    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UsersTable>().HasData(
                ...
                new Models.UsersTable() { Id = 2, Name = "Nital Shah", Address = "152 Bayfield Street", GoalWeight = 169, StartingWeight = 185, Location = "Bayfield", PhoneNumber = "289-523-1232", PreferredTraining = "Rock Climbing" },
                new Models.UsersTable() { Id = 3, Name = "Onika Maraj", Address = "94 Duckworth Street", GoalWeight = 165, StartingWeight = 168, Location = "Allandale", PhoneNumber = "289-923-1242", PreferredTraining = "Running" },
                new Models.UsersTable() { Id = 4, Name = "Donald Duck", Address = "14 Grove Street", GoalWeight = 152, StartingWeight = 184, Location = "Mapleton", PhoneNumber = "289-912-4129", PreferredTraining = "Long Distance Sprint" },
                new Models.UsersTable() { Id = 5, Name = "Katelyn Amanda", Address = "42 Mapleton Avenue", GoalWeight = 164, StartingWeight = 195, Location = "Mapleton", PhoneNumber = "289-921-0193", PreferredTraining = "Walking" },
            ...
            modelBuilder.Entity<FacultyList>().HasData(
                ...
                new Models.FacultyList() { Id = 12, Name = "Nital Shah", Department = "Management", HomeAddress = "152 Bayfield Street", Position = "Assistant Store Manager", Shift = "Nights", PhoneNumber = "289-525-1232", StoreLocation = "Bayfield"},
                new Models.FacultyList() { Id = 13, Name = "Onika Maraj", Department = "Management", HomeAddress = "94 Duckworth Street",Position = "Lead Days Manager", Shift = "Days", PhoneNumber = "289-923-1242", StoreLocation = "Allandale"},
                new Models.FacultyList() { Id = 14, Name = "Donald Duck", Department = "Management", HomeAddress= "14 Grove Street", Position = "Assistant Days Manager", Shift = "Days", PhoneNumber = "289-912-4129", StoreLocation = "Mapleton" },
                new Models.FacultyList() { Id = 15, Name = "Katelyn Amanda", Department = "Fitness Trainer", HomeAddress= "42 Mapleton Avenue", Position = "Zuumba", Shift = "Nights", PhoneNumber = "289-921-0193", StoreLocation = "Mapleton"},
            ...
            modelBuilder.Entity<CourseList>().HasData(
                ...
                new Models.CourseList() { Id = 21, CourseName = "Synchronized Swimming", Instructor = "Katelyn Amanda", Location = "Mapleton", PhysicalActivity = "Swimming", Time = "Alternating Thursday's from 5-10pm" },
            ...
            modelBuilder.Entity<TimeOffSchedule>().HasData(
                new Models.TimeOffSchedule() { Id = 24, Name = "Tyler Lindley", Date = "January 1st to February 4th", CoveredBy = "Nital"},
                new Models.TimeOffSchedule() { Id = 25, Name = "Donald Duck", Date = "January 1st to February 4th", CoveredBy = "Nital" },
                new Models.TimeOffSchedule() { Id = 26, Name = "Katelyn Amanda", Date = "Februay 24th to February 29th", CoveredBy = "Tyler" },
                new Models.TimeOffSchedule() { Id = 27, Name = "Nital Shah", Date = "Februay 24th to February 29th", CoveredBy = "Tyler" }
                );
        }
    }
}
